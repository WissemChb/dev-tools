...
cat <<"EOF" > ~/.p10k.zsh
# Generated by Powerlevel10k configuration wizard on 2023-02-21 at 14:23 UTC.
...
[ -d ${ZSH:-~/.oh-my-zsh}/completions ] || mkdir ${ZSH:-~/.oh-my-zsh}/completions

kubectl completion zsh > ${ZSH:-~/.oh-my-zsh}/completions/_kubectl
helm completion zsh > ${ZSH:-~/.oh-my-zsh}/completions/_helm
flux completion zsh > ${ZSH:-~/.oh-my-zsh}/completions/_flux
cilium completion zsh > ${ZSH:-~/.oh-my-zsh}/completions/_cilium

# Setup Gloo
curl -sL https://run.solo.io/gloo/install | sh
echo 'export PATH=$HOME/.gloo/bin:$PATH' >> $HOME/.zshrc
glooctl completion zsh > ${ZSH:-~/.oh-my-zsh}/.oh-my-zsh/completions/_glooctl
